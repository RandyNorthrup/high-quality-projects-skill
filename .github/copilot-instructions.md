...
This repository provides three vendor-neutral workflows for holding a codebase to
...
- **Delivering or resuming scoped features** → follow `skills/feature_delivery/SKILL.md`

Read the whole workflow file before acting on it. All begin with a mandatory
